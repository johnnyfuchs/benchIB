#import "ViewControllerPlainN.h"
#import "ViewControllerPlainO.h"
#import "Shared.h"
@interface ViewControllerPlainN ()
...
@end
@implementation ViewControllerPlainN
-(instancetype) init {
    if(self = [super init]){
...
- (void) viewDidAppear:(BOOL)animated {
    ViewControllerPlainO *vc = [[ViewControllerPlainO alloc] init];

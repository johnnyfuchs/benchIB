#import "ViewControllerPlainH.h"
#import "ViewControllerPlainI.h"
#import "Shared.h"
@interface ViewControllerPlainH ()
...
@end
@implementation ViewControllerPlainH
-(instancetype) init {
    if(self = [super init]){
...
- (void) viewDidAppear:(BOOL)animated {
    ViewControllerPlainI *vc = [[ViewControllerPlainI alloc] init];
